        ...
        <footer className="w-full py-16">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    <ul className="text-md flex items-center text-gray-400 justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-8 mb-10 border-b border-gray-200">
                    ...
                    <div className="flex space-x-10 justify-center items-center mb-10">
                        <a href="https://www.instagram.com/201academy/" target="_blank" className="block transition-all duration-500 hover:text-zinc-700  focus:text-zinc-700">
                        ...
                        <a href="https://www.facebook.com/@201martialarts" target="_blank" className="block transition-all duration-500 hover:text-zinc-700  focus:text-zinc-700">
                    ...
                    <span className="text-sm text-neutral-800 text-center block">©ralucaF 2024, All rights reserved.</span>
                </div>
            </div>
        </footer>
