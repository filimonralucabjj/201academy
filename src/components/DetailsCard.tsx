    ...
    return (
        <section id={props.info.sectionId} className="mb-10">
            <div className="px-4 mx-auto max-w-screen-xl text-center">
                <div className={` ${props.black ? "" : "bg-neutral-900"} gap-16 items-center mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 py-16 px-16 rounded-lg shadow brightness-70`}>
