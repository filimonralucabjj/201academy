...
export const NavBar = () => {
    ...
    const navigationItems: ItemType[] = t('navigation', { returnObjects: true }) as ItemType[];
            ...
            <div className={`${openNavigation ? "bg-zinc-950" : ""} mx-auto max-w-7xl px-6 sm:px-10 lg:px-8`}>
                <div className="flex h-20 items-center justify-between">
                    ...
                    >
                        ...
                        <div className={`${openNavigation ? "flex pb-[5rem]" : "hidden"} bg-zinc-950 fixed top-[5rem] left-0 right-0 lg:bg-transparent lg:static lg:flex ml-auto items-center justify-center`}>
                            <div className={`${openNavigation ? "relative z-2 flex flex-col" : "space-x-2"} lg:block items-center justify-center m-auto`}>
